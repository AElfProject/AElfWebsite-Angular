...
@Component({
  selector: 'app-webwallet',
  templateUrl: './webwallet.component.html',
  styleUrls: ['./webwallet.component.css']
})

export class WebwalletComponent implements OnInit, AfterViewInit {
