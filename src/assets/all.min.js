/*! legenddigital.com.au - v1.0.0 - 2017-09-17 */
...
$(".menu-btn").bind("click",function(){$(".header").hasClass("active-menu")?($(".header").removeClass("active-menu"),$(".menu-list").removeClass("active")):($(".header").addClass("active-menu"),$(".menu-list").addClass("active"))})}),$(window).load(function(){if(device.android()||device.ios())$("#skrollr-body").height("auto");else{var a=skrollr.init({forceHeight:!1,mobileCheck:function(){return!1}});a.isMobile()&&a.destroy()}});
